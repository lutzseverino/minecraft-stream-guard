...
final class CachingStreamMetadataProviderTest {
    ...
    void cachesMetadataUntilTtlExpires() {
        ...
        StreamMetadataProvider delegate = link -> Optional.of(new LiveStreamMetadata(
                link.channel(),
                "Title " + calls.incrementAndGet(),
                null,
                null,
                null,
                null
        ...
        CachingStreamMetadataProvider provider = new CachingStreamMetadataProvider(delegate, clock, Duration.ofSeconds(60));
