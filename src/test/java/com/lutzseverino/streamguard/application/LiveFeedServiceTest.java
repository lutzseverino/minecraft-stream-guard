...
final class LiveFeedServiceTest {
  ...
  private static final UUID LIVE_PLAYER_ID =
      UUID.fromString("00000000-0000-0000-0000-000000000010");
  private static final UUID OFFLINE_PLAYER_ID =
            ...
            Map.of(
                ...
                PlayerAccessRecord.empty(LIVE_PLAYER_ID, "LiveLutz")
                    ...
                    .withVerificationStatus(
                        VerificationStatus.live(StreamProviderId.TWITCH, NOW, "live")),
                OFFLINE_PLAYER_ID,
                PlayerAccessRecord.empty(OFFLINE_PLAYER_ID, "OfflineLutz")
                    .withStreamLink(
                        new StreamLink(StreamProviderId.YOUTUBE, "UC_x5XG1OV2P6uZZ5FSM9Ttw"))
  ...
  void snapshotEnrichesVerifiedPlayersWithProviderMetadata() {
    ...
    LiveFeedService service =
        new LiveFeedService(repository, metadataProvider, Clock.fixed(NOW, ZoneOffset.UTC));

    LiveFeedSnapshot snapshot =
        service.snapshot(List.of(new LiveFeedPlayer(LIVE_PLAYER_ID, "CurrentLiveLutz")));
