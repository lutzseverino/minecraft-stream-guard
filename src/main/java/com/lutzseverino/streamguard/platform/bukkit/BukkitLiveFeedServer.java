...
public final class BukkitLiveFeedServer {
    ...
    public BukkitLiveFeedServer(
            ...
            StreamGuardSettings.LiveFeed settings
    ) {
        this.plugin = plugin;
    ...
    public void start() {
        ...
        try {
            ...
            plugin.getLogger().log(Level.WARNING, "Could not start StreamGuard live feed API.", exception);
            stop();
        }
    }
    ...
    private void scheduleRefresh() {
        ...
        refreshTask = plugin.getServer().getScheduler().runTaskTimer(plugin, this::refresh, intervalTicks, intervalTicks);
    }
