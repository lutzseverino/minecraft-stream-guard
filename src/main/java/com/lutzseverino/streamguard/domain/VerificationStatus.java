...
public record VerificationStatus(
    boolean live, StreamProviderId providerId, Instant checkedAt, String detail) {
  ...
  public static VerificationStatus live(
      StreamProviderId providerId, Instant checkedAt, String detail) {
