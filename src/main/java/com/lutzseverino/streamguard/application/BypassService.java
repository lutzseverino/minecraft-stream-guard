...
public final class BypassService {
  ...
  public BypassGrant grant(
      UUID playerId, String playerName, UUID grantedBy, Duration duration, String reason) {
    ...
    PlayerAccessRecord accessRecord =
        repository.getOrCreate(playerId, playerName).withBypassGrant(grant);
